...
Sandcastle.addToolbarButton('Custom styling', function () {
    ...
    let promise = Cesium.GeoJsonDataSource.load('../../SampleData/ne_10m_us_states.topojson');
    promise.then(function (dataSource) {
        ...
        for (let i = 0; i < entities.length; i++) {
            ...
            entity.polygon.extrudedHeight = new Cesium.ConstantProperty(properties.Population / 50.0);
        }
    }, function (error) {
